...
namespace MyBlog.Data.Migrations
{
    ...
    [Migration("20240401092239_Mig_TryExtensionsMethod")]
    partial class Mig_TryExtensionsMethod
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyBlog.Entity.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 4, 1, 12, 22, 39, 495, DateTimeKind.Local).AddTicks(4417),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 4, 1, 12, 22, 39, 495, DateTimeKind.Local).AddTicks(4424),
            ...
            modelBuilder.Entity("MyBlog.Entity.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 4, 1, 12, 22, 39, 495, DateTimeKind.Local).AddTicks(5731),
                            IsDeleted = false,
                            Name = "ASP .Net Core"
                        },
                        new
                        {
                            Id = new Guid("0eb19997-5c94-4fcd-a327-fdd99e7b807c"),
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 4, 1, 12, 22, 39, 495, DateTimeKind.Local).AddTicks(5735),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("MyBlog.Entity.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 4, 1, 12, 22, 39, 495, DateTimeKind.Local).AddTicks(6976),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 4, 1, 12, 22, 39, 495, DateTimeKind.Local).AddTicks(6993),
                            FileName = "/images/test",
                            FileType = "png",
                            IsDeleted = false
                        });
